...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="#" onclick="window.print();return false;" class="btn btn-sm btn-outline-primary">Print</a>
            <a href="{{ route('cashier.sales.index') }}" class="btn btn-sm btn-outline-secondary">Back</a>
        </div>
    </div>

    <div class="card p-3" id="receiptContent">
        <div class="row mb-2">
            <div class="col-8">
